    ...
    <style>
        * {
        ...
        .link-white-no-underline:hover {
            ...
            /* Hoặc giữ none nếu không muốn gạch chân */
        }
...
<body>
    <header class="main-header">
        ...
        <div class="user-section">
            ...
            <?php else: ?>
                <a href="src/Views/logout.php" style="text-decoration: none; font-weight:bold; color:white; margin-right:20px">Đăng nhập</a>
            <?php endif; ?>
        </div>
